...
const commands = new Set(['ready', 'submit', 'cancel-model', 'voice-command', 'memory', 'credential', 'workbench-save', 'workbench-open', 'workbench-check', 'persona-load', 'persona-save', 'persona-reset', 'thinking-load', 'thinking-save', 'quit']);
