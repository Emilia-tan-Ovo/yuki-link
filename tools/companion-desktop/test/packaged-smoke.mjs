...
const cleanEnv = { ...process.env, PATH: [process.env.SystemRoot + '\\System32', process.env.SystemRoot].join(';') };
...
try { console.log(await run('first')); console.log(await run('reopen')); }
